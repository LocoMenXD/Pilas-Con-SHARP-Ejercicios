...
// Desarrolle un programa en consola con un menú para el usuario que permita agregar
// elementos a una pila, eliminar elementos de la pila, vaciar la pila completa y mostrar la pila en pantalla,
// el programa solo debe aceptar números enteros del 1 al 99. Si el usuario introduce una opción que no existe
// o un valor erróneo el programa de avisar al usuario con un mensaje en pantalla y continuar con el programa.


namespace Pilas_con_SHARP_PAA
{
    class Program
    {
